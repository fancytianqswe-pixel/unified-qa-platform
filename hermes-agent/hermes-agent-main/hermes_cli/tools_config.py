...
CONFIGURABLE_TOOLSETS = [
    ...
    ("xingyan_datasource", "🔗 统一质检平台数据源",         "测连/列字段/样例，HTTP 调 Next /api/datasource/*（默认并入 API Server）"),
]
...
_TOOLSET_PLATFORM_RESTRICTIONS: Dict[str, Set[str]] = {
    ...
    # 仅 API Server（网关）需要直连 Next；其它平台配置里隐藏以免误关核心能力
    "xingyan_datasource": {"api_server"},
}
